...
// import SpringValues from "./SpringValues";
...
//         <h className="text-5xl font-bold text-black mb-6 font-poppins">
//           Our Services
//         </h>
...
//               <div
//                 key={index}
//                 className="bg-yellow-200 border border-gray-200 shadow-sm rounded-xl p-6 flex flex-col items-center justify-between h-56 
